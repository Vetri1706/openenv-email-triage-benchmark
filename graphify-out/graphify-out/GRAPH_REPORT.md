...
## Corpus Check
- 15 files · ~7,871 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 117 nodes · 200 edges · 13 communities detected
...
6. `run_loop()` - 7 edges
7. `EmailTriageClient` - 7 edges
8. `GmailProvider` - 7 edges
9. `GraphProvider` - 7 edges
10. `_build_email_record()` - 6 edges
...
Cohesion: 0.16
Nodes (11): _build_email_record(), build_provider(), create_escalation_ticket(), _decode_header_value(), _extract_text_body(), GmailProvider, GraphProvider, _infer_priority() (+3 more)
...
Cohesion: 0.47
Nodes (8): main(), _priority_rank(), _run_live_once(), _run_simulated_once(), RunStats, _select_next_email(), _summarize(), _value_rank()
...
- **Why does `ImapProvider` connect `Community 7` to `Community 1`?**
  _High betweenness centrality (0.056) - this node is a cross-community bridge._
- **Why does `LiveEmailSession` connect `Community 0` to `Community 1`?**
